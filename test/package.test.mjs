...
test("Traditional Chinese README exists for zh-TW users", async () => {
  ...
  assert.match(herdr, new RegExp(`${chars(0x975e)} Git[\\s\\S]{0,80}${chars(0x7565, 0x904e)}[\\s\\S]{0,40}exclusion[\\s\\S]{0,100}${chars(0x5fc5, 0x9808, 0x81ea, 0x884c, 0x4fdd, 0x8b77)}`))
